...
@Component({
  selector: 'app-milling-cutter-rul',
  templateUrl: './milling-cutter-rul.component.html',
  styleUrls: ['./milling-cutter-rul.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class MillingCutterRulComponent implements OnInit, OnDestroy {
  ...
  constructor(private location: Location, private logger: LoggerService, private milcutterService: MillingCutterRulService, private router: Router, private route: ActivatedRoute, private boostService: CommonService,private laguage:LanguageService) {
    ...
    console.log(this.laguage.language$)
  }

  goback(): void { this.location.back() }
  ngOnInit(): void {
    this.logout_timer = environment.logout_timer;
    this.logger.info(this.uname, this.uname + " Milling Cutter Page has opened");
    this.logger.info(this.uname,this.uname+ " Milling Cutter Page has opened");
  }


  checkAccessForUsecase(): any {
    if (!(this.ucases.indexOf('Remaining Useful Life of Milling Cutter') > -1)) {
  ...
  public millin() {
    // this.milcutterService.getMilDataPageNumber().subscribe( 
    //     res=>{console.log("res: ", res)}); 
    //     console.log("getMilDataPageNumber()")


    Swal.fire({
      text: 'Milling Cutter Usecase has started',
      showCancelButton: false,
      confirmButtonColor: '#3085d6',
      confirmButtonText: 'OK',
    });
    this.logger.info(this.uname, "Milling Cutter Usecase started");
  ...
  public milling_usecase() {
    ...
    if (this.in == 1) {
        ...
        this.predictions1 = new Chart('probabilities', {
            ...
            options: {
                title: { display: true, text: 'Probability of Failure (%)', fontSize: 15 }, 
                scales:
    ...
    this.milcutterService.getMilData(this.in)
        .subscribe(data => 
        {
            ...
            if (this.mysv[0] > 0) {
                ...
                this.S1_AV.push(this.mysv[6]);
                this.S1_CP.push(this.mysv[7]);
                this.S1_CV.push(this.mysv[8]);
                ...
                if(this.graph_id==1)
                {
                    ...
                    this.S1_CV1.options.title.text = "Actual Velocity (mm/s)";
                ...
                if (this.probabliw[this.probabliw.length - 1] >= 70) {
...
disp() {
    this.logger.info(this.uname,"Compare button of Milling Cutter UseCase has been clicked");
...
public Stop() {
  ...
  Swal.fire({
    text: 'Milling Cutter Usecase has stopped',
    showCancelButton: false,
    confirmButtonColor: '#3085d6',
    confirmButtonText: 'OK',
  });

    this.logger.info(this.uname,"Milling Cutter Usecase stopped");
